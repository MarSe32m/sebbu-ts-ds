...
public final class SpinlockedPriorityQueue<Element>: @unchecked Sendable where Element: Comparable {
    @usableFromInline
...
extension SpinlockedPriorityQueue: CustomStringConvertible {
...
extension SpinlockedPriorityQueue: CustomDebugStringConvertible {
